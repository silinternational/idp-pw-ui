(function () {
    ...
    function VerifyMethodController($routeParams, verifyService, dialogService, dataService,
        ...
        function displayBadCarrierWarning() {
            dialogService.info('If you do not receive a text message or phone call within five minutes it could be because your telephone company is not supported. We know Republik Wireless and some VOIP office systems are not supported.');
        }
